...
com.jumio.nv.NativeClasses = (function() {
    ...
    function importClasses() {
        ...
        nativeClasses.NetverifyInitiateCallback = java.newClass("NetverifyInitiateCallback", "java.lang.Object", ["com.jumio.nv.NetverifyInitiateCallback"], {
            onNetverifyInitiateSuccess: function() {
                this.onSuccess();
            },
            onNetverifyInitiateError: function(errorCode, errorDetail, errorMessage, retryPossible) {
                this.onError(errorCode, errorDetail, errorMessage, retryPossible);
            },
            onSuccess: null,
            onError: null
        });
