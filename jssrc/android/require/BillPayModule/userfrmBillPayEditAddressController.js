define({
    ...
    initActions: function() {
        ...
        var entryPoint = navManger.getEntryPoint("editBillPayPayee");
    ...
    setDataToForm: function(payeeData) {
        var scope = this;
        var address = "";
        scope.view.txtAddressLineOne.text = (payeeData.addressLine1 && payeeData.addressLine1 !== "" && payeeData.addressLine1 !== null) ? payeeData.addressLine1 : (payeeData.street && payeeData.street !== "" && payeeData.street !== null) ? payeeData.street : "";
