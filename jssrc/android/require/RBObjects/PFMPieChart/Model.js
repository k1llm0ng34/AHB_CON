define([], function() {
    ...
    function PFMPieChart(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "cateforyId": {
                get: function() {
                    return privateState.cateforyId
                },
                set: function(val) {
                    throw Error("cateforyId cannot be changed.");
                },
                enumerable: true,
            },
            "categoryName": {
            ...
            "totalCashSpent": {
                get: function() {
                    return privateState.totalCashSpent
                },
                set: function(val) {
