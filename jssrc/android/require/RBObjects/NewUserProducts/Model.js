define([], function() {
    ...
    function NewUserProducts(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "productDescription": {
                get: function() {
                    return privateState.productDescription
                },
                set: function(val) {
            ...
            "productId": {
                get: function() {
                    return privateState.productId
                },
                set: function(val) {
                    throw Error("productId cannot be changed.");
                },
                enumerable: true,
            },
            "productImageURL": {
                get: function() {
                    return privateState.productImageURL
                },
                set: function(val) {
            ...
            "productName": {
                get: function() {
                    return privateState.productName
                },
                set: function(val) {
            ...
            "productType": {
                get: function() {
                    return privateState.productType
                },
                set: function(val) {
            ...
            "productTypeId": {
                get: function() {
                    return privateState.productTypeId
                },
                set: function(val) {
            ...
            "termsAndConditions": {
                get: function() {
                    return privateState.termsAndConditions
                },
                set: function(val) {
    ...
    NewUserProducts.registerValidator = function() {
        ...
        //For Operation 'getAllProducts' with service id 'getAllProducts9820'
