define([], function() {
    ...
    function Payee(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "billDescription": {
                get: function() {
                    return privateState.billDescription
                },
                set: function(val) {
            ...
            "billerCategory": {
                get: function() {
                    return privateState.billerCategory
                },
                set: function(val) {
            ...
            "companyName": {
                get: function() {
                    return privateState.companyName
                },
                set: function(val) {
            ...
            "eBillStatus": {
                get: function() {
                    return privateState.eBillStatus
                },
                set: function(val) {
            ...
            "lastPaidAmount": {
                get: function() {
                    return privateState.lastPaidAmount
                },
                set: function(val) {
            ...
            "lastPaidDate": {
                get: function() {
                    return privateState.lastPaidDate
                },
                set: function(val) {
            ...
            "nameOnBill": {
                get: function() {
                    return privateState.nameOnBill
                },
                set: function(val) {
            ...
            "paidAmount": {
                get: function() {
                    return privateState.paidAmount
                },
                set: function(val) {
            ...
            "payeeId": {
                ...
                set: function(val) {
                    throw Error("payeeId cannot be changed.");
                },
                enumerable: true,
            },
            "payeeName": {
            ...
            "routingCode": {
                get: function() {
                    return privateState.routingCode
                },
                set: function(val) {
            ...
            "isManuallyAdded": {
                get: function() {
                    return privateState.isManuallyAdded
                },
                set: function(val) {
