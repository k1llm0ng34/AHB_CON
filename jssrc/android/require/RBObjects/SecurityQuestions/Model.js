define([], function() {
    ...
    function SecurityQuestions(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "SecurityID": {
                get: function() {
                    return privateState.SecurityID
                },
                set: function(val) {
                    throw Error("SecurityID cannot be changed.");
                },
                enumerable: true,
            },
            "userName": {
            ...
            "securityQuestions": {
                get: function() {
                    return privateState.securityQuestions
                },
                set: function(val) {
    ...
    SecurityQuestions.getbypk = function(params, onCompletion) {
        return SecurityQuestions.customVerb('getbypk', params, onCompletion);
    };
