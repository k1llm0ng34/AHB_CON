define([], function() {
    ...
    function PayPerson(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "PayPersonId": {
                get: function() {
                    return privateState.PayPersonId
                },
                set: function(val) {
                    throw Error("PayPersonId cannot be changed.");
                },
                enumerable: true,
            },
            "phone": {
            ...
            "primaryContactForSending": {
                get: function() {
                    return privateState.primaryContactForSending
                },
                set: function(val) {
            ...
            "secondaryPhoneNumber": {
                get: function() {
                    return privateState.secondaryPhoneNumber
                },
                set: function(val) {
