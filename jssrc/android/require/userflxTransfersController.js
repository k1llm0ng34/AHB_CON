define({
    ...
    "onViewCreated": function() {
        ...
        this.view.addGestureRecognizer(constants.GESTURE_TYPE_SWIPE, {
            ...
            if (applicationManager.getPresentationUtility().rowIndexforSwipe >= 0 && previousSection >= 0) self.animateRight(applicationManager.getPresentationUtility().rowIndexforSwipe, previousSection);
