define("SettingsModule/frmPreferencesTouchId", function() {
    return function(controller) {
        function addWidgetsfrmPreferencesTouchId() {
            ...
            customHeader.lblLocateUs.text = kony.i18n.getLocalizedString("kony.mb.devReg.TouchId");
            ...
            var lblNote = new kony.ui.Label({
                ...
                "text": kony.i18n.getLocalizedString("kony.mb.preferences.WouldYouLikeToUseTouchIdToLoginUsingYourBiometricsInsteadOfEnteringYourUsernameAndPassword?"),
                "textStyle": {
                    "letterSpacing": 0,
                    "strikeThrough": false
                },
        ...
        return [{
            ...
            "skin": "sknFrmffffff",
            "title": kony.i18n.getLocalizedString("kony.mb.devReg.TouchId")
        }, {
