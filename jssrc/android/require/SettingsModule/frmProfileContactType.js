define("SettingsModule/frmProfileContactType", function() {
    return function(controller) {
        function addWidgetsfrmProfileContactType() {
            ...
            flxTransactionFrequency.add(segContactType);
            this.add(flxHeader, flxTransactionFrequency);
        };
        return [{
            "addWidgets": addWidgetsfrmProfileContactType,
            "enabledForIdleTimeout": true,
            "id": "frmProfileContactType",
            "init": controller.AS_Form_d1243bee5f5743e3a793334ad954e8e2,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": controller.AS_Form_a380f1a7ac3d4fc5bca017a6ed16a15c,
            "skin": "sknFrmf9f9f9",
