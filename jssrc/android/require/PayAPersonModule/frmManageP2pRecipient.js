define("PayAPersonModule/frmManageP2pRecipient", function() {
    return function(controller) {
        function addWidgetsfrmManageP2pRecipient() {
            ...
            customHeader.lblLocateUs.text = "Recipient Details";
            ...
            flxMainContainer.add(flxShadow, lblRecipientNameTitle, lblRecipientNameValue, lblRecipientContactTitle, lblRecipientContact, lblRecipientNickNameTitle, lblRecipientNickNameValue);
            ...
            this.add(flxHeader, flxHeaderSearchbox, flxMainContainer, btnDeleteRecipient, btnPayAPerson, flxPopup);
        };
        return [{
            ...
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": controller.AS_Form_h5a445d7dab84d8790af30b592bb9df2,
            "skin": "sknFrmffffff",
