...
define([], function() {
    ...
    LoggerManager.prototype.sendCustomMetrics = function(Modulename) {
        ...
        switch (Modulename) {
            case "TRANSFERS":
                ...
                KNYMetricsService.sendCustomMetrics("frmConfirmTransferCD", {
                    "TransferStatus": "Domestic Transfer",
                    "paymentType": "Transfers",
                    "TransferAverageAmount": parseInt(amount)
                });
                break;
            case "PAYAPERSON":
                ...
                KNYMetricsService.sendCustomMetrics("frmConfirmTransferCD", {
                    "P2PStatus": "P2P Transfers",
                    "paymentType": "P2P Payment",
                    "P2PAverageAmount": parseInt(amount)
                });
                break;
            case "BILLPAY":
                ...
                KNYMetricsService.sendCustomMetrics("frmConfirmTransferCD", {
                    "PayBillStatus": "Bill Payments",
                    "paymentType": "Bill Pay",
                    "payBillAverageAmount": parseInt(amount)
                });
                break;
            case "CHECKDEPOSIT":
                KNYMetricsService.sendCustomMetrics("frmConfirmTransferCD", {
    ...
    LoggerManager.prototype.getParamsForAnalytics = function(view, metricName) {
        ...
        return {
            formId: data[1],
            moduleName: {
                "Accessed Modules": metricName,
                "Ages": this.getAgeGroup()
            }
        }
    };
    /**
