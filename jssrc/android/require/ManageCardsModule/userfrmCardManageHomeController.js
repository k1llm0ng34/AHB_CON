define({
    ...
    cardsFetchSuccess: function(response) {
        ...
        try {
            ...
            if (!kony.sdk.isNullOrUndefined(response) && response.length > 0) {
                ...
                this.view.setTitleBarRightSideButtonSkin(" ", "TitleBarRightButtonSKin", this.navigateToCardMngDetails);
            }
        } catch (err) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
            throw GlobalExceptionHandler.addMessageAndActionForException(err, "kony.error.LoadingFormFailed", GlobalExceptionHandler.ActionConstants.ALERT, arguments.callee.name);
    ...
    setDataForCards: function() {
        ...
        try {
            ...
            this.cardListImages = ["atmcardred.png", "atmcardblue.png", "atmcardgreen.png", "atmcardred.png", "atmcardblue.png", "atmcardgreen.png", "atmcardblue.png", "atmcardgreen.png", ];
        } catch (err) {
            throw GlobalExceptionHandler.addMessageAndActionForException(err, "kony.error.LoadingFormFailed", GlobalExceptionHandler.ActionConstants.ALERT, arguments.callee.name);
        }
    },
