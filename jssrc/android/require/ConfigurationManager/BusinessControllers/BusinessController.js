        ...
        this.OLBConstants = {
            ...
            CONFIG: {
                ACCOUNTS_QUICK_ACTIONS: {
                    "Savings": ["Transfer Money", "Stop Check Payment", "View Statements"],
                    "Checking": ["Transfer Money", "Send Money", "Pay a Bill", "Stop Check Payment", "View Statements"],
                    "CreditCard": ["Pay a Bill", "View Statements"
                        //"Pay Due Amount" Not in scope
                    ],
                    "Loan": ["Pay Due Amount", "View Statements", "Update Account Settings"],
                    "Line of Credit": [
                        //"Pay Due Amount",
                        "View Statements", "Update Account Settings"
                    ],
                    "Mortgage": [
                        //"Pay Due Amount",
                        "View Statements", "Update Account Settings"
                ...
                EXTERNAL_ACCOUNT_QUICK_ACTIONS: ["Remove Account", "Account Preferences", "Edit Account", ],
                ACCOUNTS_RIGHTSIDE_ACTIONS: {
                    "Savings": ["Scheduled Transactions", "Make A Transfer"],
                    "Checking": ["Scheduled Transactions", "Make A Transfer", "Pay a Bill"],
                    "CreditCard": ["Scheduled Transactions", "View Statements"
                        //"Pay Due Amount" Not in scope
                    ],
                    "Loan": ["Pay Due Amount", "View Statements", "Update Account Settings"],
                    "Line of Credit": [
                ...
                ACCOUNTS_SECONDARY_ACTIONS: {
                    "Savings": ["View Statements", "Stop Check Payment", "Update Account Settings"
                        //"Order Checks", //Post R4
                        //"Manage Card" //Post R4
                    ],
                    "Checking": ["Send Money", "View Statements", "Stop Check Payment", "Update Account Settings",
                        //"Order Checks", //Post R4
                        //"Manage Card" //Post R4
                    ],
                    "CreditCard": ["Pay a Bill", "Update Account Settings",
                        //"Manage Card", //Post R4
