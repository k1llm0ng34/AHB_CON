define({
    ...
    animateFlxUp: function() {
        var flx;
        if (this.view.flxDirections.isVisible) flx = this.view.flxDirections;
        else flx = null;
        if (flx !== null) {
            ...
            if (this.view.flxDirections.isVisible) this.showFullDirections();
        }
    },
    animateFlxDown: function() {
        ...
        if (flx !== null) {
            ...
            if (this.view.flxDirections.isVisible) this.showgetDirections();
        }
    },
    bindData: function() {
        var navManager = applicationManager.getNavigationManager();
