...
define([], function() {
    ...
    DeviceUtilManager.prototype.getDeviceInfo = function() {
        ...
        if (this.isIPhone()) {
            if (version < 6) deviceID = this.deviceInfo.customdeviceid;
            else deviceID = this.deviceInfo.identifierForVendor;
        } else {
    ...
    DeviceUtilManager.prototype.isIphoneX = function() {
        if (this.deviceInfo.model == "iPhone X") return true;
        else return false;
    };
    /**
    ...
    DeviceUtilManager.prototype.getImageURLBasedOnDeviceType = function(baseurl) {
        ...
        if (deviceData.name === "iPhone") {
            if (deviceData.model.indexOf("iPhone 4") > -1) bannerUrl = bannerUrl + ".png";
            else if (deviceData.model.indexOf("iPhone 5") > -1) bannerUrl = bannerUrl + "@2x.png";
            else if (deviceData.model.indexOf("iPhone 6") > -1) bannerUrl = bannerUrl + "@3x.png";
            else bannerUrl = bannerUrl + "@3x.png";
        } else {
