...
define([], function() {
    ...
    RecipientsManager.prototype.fetchAllExternalBenificiaries = function(presentationManageBenificiarySuccess, presentationManageBenificiaryError) {
        var recepientsRepo  =  kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("ExternalAccounts");
        recepientsRepo.customVerb('getOtherBankAccount', {}, fetchAllExternalBenificiariesCompletionCallback);
    ...
    RecipientsManager.prototype.setBillPayPayeeAddressDetails = function(payeeData) {
        this.billPayPayeeData.addressLine1 = (payeeData.addressLine1 && payeeData.addressLine1 !== "" && payeeData.addressLine1 !== null) ? payeeData.addressLine1 : (payeeData.street && payeeData.street !== "" && payeeData.street !== null) ? payeeData.street : "";
    ...
    RecipientsManager.prototype.getBillPayPayeeAddressDetails = function() {
        var address = {};
        address.addressLine1 = (this.billPayPayeeData.addressLine1 && this.billPayPayeeData.addressLine1 !== "" && this.billPayPayeeData.addressLine1 !== null) ? this.billPayPayeeData.addressLine1 : (this.billPayPayeeData.street && this.billPayPayeeData.street !== "" && this.billPayPayeeData.street !== null) ? this.billPayPayeeData.street : "";
