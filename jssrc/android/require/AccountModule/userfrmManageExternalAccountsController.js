define({
    ...
    fetchSingleExternalAccountDetails: function(segWidget) {
        ...
        try {
            ...
            if (this.segTransactionsSwipeInfo === undefined || this.segTransactionsSwipeInfo === null) this.segTransactionsSwipeInfo = {
                isSwiped: false,
                position: 1,
                indices: {
    ...
    swipeDetected: function(widgetInfo, swipeInfo) {
        ...
        try {
            ...
            if (this.segTransactionsSwipeInfo !== undefined && this.segTransactionsSwipeInfo !== null) this.segTransactionsSwipeInfo.isSwiped = false;
            loggerManager.log("#### in catch " + JSON.stringify(err) + " ####");
        }
    },
