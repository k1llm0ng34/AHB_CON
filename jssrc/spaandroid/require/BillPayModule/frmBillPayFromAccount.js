define("BillPayModule/frmBillPayFromAccount", function() {
    return function(controller) {
        function addWidgetsfrmBillPayFromAccount() {
                ...
                "data": [
                    [{
                        ...
                        [{
                            ...
                            "lblAccountName": "Stephen Howard",
                            "lblAccountNumber": " ",
                            "lblBankName": "My Checking Account",
                            "lblDelete": "Delete"
                        }, {
                            "imgDelete": "deleteicon.png",
                            "lblAccountBal": "Available balance",
            ...
            flxBlueBg.add();
            this.add(flxHeader, flxHeaderSearchbox, flxMainContainer, flxPopup, flxBlueBg);
        };
        return [{
            "addWidgets": addWidgetsfrmBillPayFromAccount,
            "bounces": false,
            "enableScrolling": true,
            "enabledForIdleTimeout": true,
            "id": "frmBillPayFromAccount",
            "init": controller.AS_Form_j011bdac71404a5f8d997eeb3c1b8df3,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": controller.AS_Form_faaa5747981c4d58bce6f228944315be,
            "skin": "sknFrmffffff",
            "i18n_title": "kony.i18n.getLocalizedString(\"kony.mb.common.FromAccount\")"
        }, {
