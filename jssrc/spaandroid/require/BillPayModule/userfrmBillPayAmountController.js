define({
    ...
    setFromAccountData: function() {
        ...
        this.view.lblFromAccountValue.text = frmdata[0].accountName;
    ...
    continueOnClick: function() {
        ...
        if (Number(amount) >= Number(configManager.getConfigurationValue("minBillPayLimit")) && Number(amount) <= Number(configManager.getConfigurationValue("maxBillPayLimit"))) {
            ...
            this.showErrorPopup(kony.i18n.getLocalizedString("kony.mb.entitlements.minTransactionLimitUnreached") + " " + Number(configManager.getConfigurationValue("minBillPayLimit")));
        } else if (Number(amount) > Number(configManager.getConfigurationValue("maxBillPayLimit"))) {
            this.showErrorPopup(kony.i18n.getLocalizedString("kony.mb.entitlements.maxTransactionLimitExceeded") + " " + Number(configManager.getConfigurationValue("maxBillPayLimit")));
        }
    },
