define(["AsyncManager/BusinessControllers/BusinessController"], function(AsyncManager) {
    ...
    BillPay_PresentationController.prototype.updateEBillStatus = function(rec, status) {
        var recipientsManager = applicationManager.getRecipientsManager();
        if (status === false) recipientsManager.modifyEBillStatus(rec, scope_BillPayPresentationController.updateActiveEBillSuccess, scope_BillPayPresentationController.updateActiveEBillError);
        else recipientsManager.modifyEBillStatus(rec, scope_BillPayPresentationController.updateDeactiveEBillSuccess, scope_BillPayPresentationController.updateDeactiveEBillError);
    };
