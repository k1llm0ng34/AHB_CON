...
define([], function() {
    ...
    StorageManager.prototype.setStoredItem = function(key, value) {
        if (key == undefined || key == null) kony.print("Key is undefined");
        else if (value == undefined || value == null) kony.print("value is undefined");
        else kony.store.setItem(key, value);
    };
    /**
    ...
    StorageManager.prototype.setStoredEncryptedItem = function(key, value) {
        ...
        else kony.store.setItem(key, this.EncryptValue(value));
    };
    /**
