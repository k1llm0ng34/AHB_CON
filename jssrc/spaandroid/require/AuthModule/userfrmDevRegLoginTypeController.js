define({
    ...
    setTouchId: function(flags) {
        if (flags.isTouchIdSupported) this.view.flxTouchId.isVisible = true;
    ...
    setFaceId: function(flags) {
        ...
        if (authMod.presentationController.isGemaltoEnabledFlag == false) {
            ...
            if (flags.isFaceIdSupported) this.setNativeFaceId(flags);
                ...
                if (flags.isFaceIdEnrolled) this.view.lblEnableFace.text = kony.i18n.getLocalizedString("kony.mb.common.enabled");
    ...
    setNativeFaceId: function(flags) {
        if (flags.isFaceIdSupported) {
            ...
            } else this.view.flxFaceId.isVisible = false;
        }
    },
    setPinLogin: function(flags) {
        if (flags.isPinEnabled) this.view.lblGenerate.text = kony.i18n.getLocalizedString("kony.mb.Generated");
