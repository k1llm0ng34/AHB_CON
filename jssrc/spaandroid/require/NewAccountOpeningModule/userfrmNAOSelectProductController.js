define({
    ...
    preShow: function() {
        ...
        this.view.tbxSearch.onTouchEnd = this.onSearchOne;
                ...
                var prolist = {
                    ...
                    "btnViewDetails": {
                        ...
                        "onClick": function(widget, context) {
                            ...
                            navMan.setCustomInfo("frmNAOProductDetails", {
                                rates: data1.rates.text,
                                info: data1.info.text,
                                features: data1.features.text,
                                productName: data1.lblProductTitle
                            })
