define("frmEStmtAccountPreferences", function() {
    return function(controller) {
        function addWidgetsfrmEStmtAccountPreferences() {
            ...
            customHeader.lblLocateUs.text = "Account Preferences";
            ...
            var lblSelectAccount = new kony.ui.Label({
                ...
                "i18n_text": "kony.i18n.getLocalizedString(\"kony.mb.EStmt.SelectAccountToSetPreferences\")",
                "textStyle": {},
            ...
            flxSubHeader.add(lblSelectAccount);
            var segSelectAccounts = new kony.ui.SegmentedUI2({
                ...
                "data": [{
                    ...
                    "lblAccountHolderName": "My Checking...2343",
                    "lblBankName": "Bank of America"
                }, {
                    "imgBank": "bankofamerica.png",
                    "imgChevron": "chevron.png",
                    "lblAccountHolderName": "My Saving...2343",
                    "lblBankName": "Bank of America"
                }, {
                    "imgBank": "bankofamerica.png",
                    "imgChevron": "chevron.png",
                    "lblAccountHolderName": "My Checking...1234",
                    "lblBankName": "Bank of America"
                }],
                "groupCells": false,
                ...
                "rowSkin": "seg2Normal",
                "rowTemplate": "flxEStmtAccountPreferences",
                "scrollingEvents": {},
                ...
                "widgetDataMap": {
                    "flxEStmtAccountPreferences": "flxEStmtAccountPreferences",
            ...
            flxMainContainer.add(flxSubHeader, segSelectAccounts);
            ...
            this.add(flxHeader, flxMainContainer, flxFooter, flxHamburger, flxPopup);
        };
        return [{
            "addWidgets": addWidgetsfrmEStmtAccountPreferences,
            "enabledForIdleTimeout": false,
            "id": "frmEStmtAccountPreferences",
            "init": controller.AS_Form_f0a81d3927e441a1aebcfa214489276e,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": controller.AS_Form_aec204e274a440948bd3838569210762,
            "skin": "sknFrmffffff",
            "i18n_title": "kony.i18n.getLocalizedString(\"kony.mb.EStmt.AccountPreferences\")"
        }, {
