...
define([], function() {
    ...
    LocateUs_PresentationController.prototype.processPolylineData = function(routeid, polyPoints, color, destinationInfo) {
        ...
        var startLoc = {
            ...
            lon: steps[0].lon,
            image: {
                source: locateUsPresentationScope.getMapPinIcon("currentLocation"),
        ...
        var endLoc = {
            ...
            lon: steps[ei].lon,
            image: {
                source: locateUsPresentationScope.getMapPinIcon(destinationInfo.type),
                anchor: kony.map.PIN_IMG_ANCHOR_CENTER
            }
        };
    ...
    LocateUs_PresentationController.prototype.getDirectionImage = function(key, value) {
        ...
        if (value != "") {
            ...
            if (splitFlag) {
                for (var k = 0;
                    ((keyArray) != null) && k < keyArray.length; k++) {
