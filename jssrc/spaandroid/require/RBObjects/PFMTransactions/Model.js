define([], function() {
    ...
    function PFMTransactions(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "getMonthlyTransactions": {
                get: function() {
                    return privateState.getMonthlyTransactions
                },
                set: function(val) {
            ...
            "getUncategorisedCount": {
                get: function() {
                    return privateState.getUncategorisedCount
                },
                set: function(val) {
            ...
            "isAnalyzed": {
                get: function() {
                    return privateState.isAnalyzed
                },
                set: function(val) {
            ...
            "isMappedToMerchant": {
                get: function() {
                    return privateState.isMappedToMerchant
                },
                set: function(val) {
            ...
            "transactionAmount": {
                get: function() {
                    return privateState.transactionAmount
                },
                set: function(val) {
            ...
            "transactionDescription": {
                get: function() {
                    return privateState.transactionDescription
                },
                set: function(val) {
            ...
            "transactionNotes": {
                get: function() {
                    return privateState.transactionNotes
                },
                set: function(val) {
            ...
            "pfmtransactionlist": {
                get: function() {
                    return privateState.pfmtransactionlist
                },
                set: function(val) {
    ...
    PFMTransactions.registerValidator = function() {
        ...
        //For Operation 'updateBulkPFMTransaction' with service id 'updateBulkPFMTransaction8095'
