define([], function() {
    ...
    function CheckOrder(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "checkOrderID": {
                get: function() {
                    return privateState.checkOrderID
                },
                set: function(val) {
                    throw Error("checkOrderID cannot be changed.");
                },
                enumerable: true,
            },
            "country": {
            ...
            "postboxNumber": {
                get: function() {
                    return privateState.postboxNumber
                },
                set: function(val) {
