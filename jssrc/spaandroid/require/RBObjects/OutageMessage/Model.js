define([], function() {
    ...
    function OutageMessage(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "messageText": {
                get: function() {
                    return privateState.messageText
                },
                set: function(val) {
            ...
            "service_id": {
                get: function() {
                    return privateState.service_id
                },
                set: function(val) {
                    throw Error("service_id cannot be changed.");
                },
                enumerable: true,
            },
            "status_id": {
                get: function() {
                    return privateState.status_id
                },
                set: function(val) {
            ...
            "outageMessageIds": {
                get: function() {
                    return privateState.outageMessageIds
                },
                set: function(val) {
