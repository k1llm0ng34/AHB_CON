define([], function() {
    ...
    function Notifications(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "notificationActionLink": {
                get: function() {
                    return privateState.notificationActionLink
                },
                set: function(val) {
            ...
            "notificationId": {
                get: function() {
                    return privateState.notificationId
                },
                set: function(val) {
                    throw Error("notificationId cannot be changed.");
                },
                enumerable: true,
            },
            "notificationModule": {
                get: function() {
                    return privateState.notificationModule
                },
                set: function(val) {
            ...
            "notificationSubModule": {
                get: function() {
                    return privateState.notificationSubModule
                },
                set: function(val) {
            ...
            "notificationSubject": {
                get: function() {
                    return privateState.notificationSubject
                },
                set: function(val) {
            ...
            "notificationText": {
                get: function() {
                    return privateState.notificationText
                },
                set: function(val) {
            ...
            "unreadNotificationCount": {
                get: function() {
                    return privateState.unreadNotificationCount
                },
                set: function(val) {
            ...
            "userNotificationId": {
                get: function() {
                    return privateState.userNotificationId
                },
                set: function(val) {
    ...
    Notifications.registerValidator = function() {
        ...
        //For Operation 'deleteNotification' with service id 'deleteNotification3609'
    ...
    //For Operation 'getUnreadNotificationCount' with service id 'getUnreadNotifications6244'
