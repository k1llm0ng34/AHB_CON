define([], function() {
    ...
    function Messages(defaultValues) {
        ...
        Object.defineProperties(this, {
            ...
            "accountNickName": {
                get: function() {
                    return privateState.accountNickName
                },
                set: function(val) {
            ...
            "categoryId": {
                get: function() {
                    return privateState.categoryId
                },
                set: function(val) {
            ...
            "categoryName": {
                get: function() {
                    return privateState.categoryName
                },
                set: function(val) {
            ...
            "createdDate": {
                get: function() {
                    return privateState.createdDate
                },
                set: function(val) {
            ...
            "deletedDate": {
                get: function() {
                    return privateState.deletedDate
                },
                set: function(val) {
            ...
            "messageId": {
                get: function() {
                    return privateState.messageId
                },
                set: function(val) {
                    throw Error("messageId cannot be changed.");
                },
                enumerable: true,
            },
            "messageType": {
                get: function() {
                    return privateState.messageType
                },
                set: function(val) {
            ...
            "receivedDate": {
                get: function() {
                    return privateState.receivedDate
                },
                set: function(val) {
            ...
            "recordNumber": {
                get: function() {
                    return privateState.recordNumber
                },
                set: function(val) {
            ...
            "subcategoryId": {
                get: function() {
                    return privateState.subcategoryId
                },
                set: function(val) {
            ...
            "subcategoryName": {
                get: function() {
                    return privateState.subcategoryName
                },
                set: function(val) {
    ...
    Messages.registerValidator = function() {
        ...
        //For Operation 'customDelete' with service id 'deleteMessage3723'
    Messages.customDelete = function(params, onCompletion) {
        return Messages.customVerb('customDelete', params, onCompletion);
    };
    //For Operation 'MessageCount' with service id 'getMessageCount2798'
