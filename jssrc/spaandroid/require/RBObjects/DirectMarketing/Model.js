define([], function() {
    ...
    var setterFunctions = {
        ...
        adTitle: function(val, state) {
            state['adTitle'] = val;
        },
        textcolor: function(val, state) {
            state['textcolor'] = val;
        },
    };
    ...
    function DirectMarketing(defaultValues) {
        ...
        privateState.adTitle = defaultValues ? (defaultValues["adTitle"] ? defaultValues["adTitle"] : null) : null;
        privateState.textcolor = defaultValues ? (defaultValues["textcolor"] ? defaultValues["textcolor"] : null) : null;
        ...
        Object.defineProperties(this, {
            ...
            "buttonType": {
                get: function() {
                    return privateState.buttonType
                },
                set: function(val) {
            ...
            "navigationId": {
                get: function() {
                    return privateState.navigationId
                },
                set: function(val) {
            ...
            "navigationType": {
                get: function() {
                    return privateState.navigationType
                },
                set: function(val) {
            ...
            "navigationURL": {
                get: function() {
                    return privateState.navigationURL
                },
                set: function(val) {
            ...
            "flowposition": {
                get: function() {
                    return privateState.flowposition
                },
                set: function(val) {
            ...
            "adTitle": {
                get: function() {
                    return privateState.adTitle
                },
                set: function(val) {
                    setterFunctions['adTitle'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "textcolor": {
                get: function() {
                    return privateState.textcolor
                },
                set: function(val) {
                    setterFunctions['textcolor'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
    ...
    DirectMarketing.registerValidator = function() {
        ...
        //For Operation 'sendDmResponse' with service id 'sendDmResponse5120'
    ...
    //For Operation 'getDirectMarketingAds' with service id 'getDirectMarketingAds2425'
