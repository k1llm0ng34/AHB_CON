define({
    ...
    getSettingsStatus: function() {
        ...
        else if (tempLoginMode == "touchid") this.defLoginStatus = kony.i18n.getLocalizedString("kony.mb.devReg.touchidTitle");
    ...
    setAccountSettings: function() {
        var data = [
            [{
                ...
                [{
                    "lblTitle": "Account Preferences",
                    "lblValue": "",
                    "imgArrow": "chevron.png"
                }, {
                    "lblTitle": "Set Default Account",
                    "lblValue": "",
                    "imgArrow": "chevron.png"
                }, ]
            ]
