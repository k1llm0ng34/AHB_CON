define("SettingsModule/frmProfileChangeUsername", function() {
    return function(controller) {
        function addWidgetsfrmProfileChangeUsername() {
            ...
            customHeader.flxHeader.left = "-0.03%";
            ...
            var rtxSecurityCode = new kony.ui.RichText({
                ...
                "i18n_text": "kony.i18n.getLocalizedString(\"kony.mb.Enroll.EnterSecurityCode\")",
                "top": "0dp",
                "zIndex": 1
            }, {
            ...
            var rtxCVV = new kony.ui.RichText({
                ...
                "right": "50dp",
                "skin": "sknRtx424242SSP26px",
                "i18n_text": "kony.i18n.getLocalizedString(\"kony.mb.common.EnterCVVInfo\")",
                "top": "0dp",
                "zIndex": 1
            }, {
                "contentAlignment": constants.CONTENT_ALIGN_MIDDLE_LEFT,
        ...
        return [{
            "addWidgets": addWidgetsfrmProfileChangeUsername,
            "enabledForIdleTimeout": true,
            "id": "frmProfileChangeUsername",
            "init": controller.AS_Form_e86c71fa24894f359d56099abc697d18,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": controller.AS_Form_i1902f3db3994f53afc8df1ff6e81309,
            "skin": "slForm",
