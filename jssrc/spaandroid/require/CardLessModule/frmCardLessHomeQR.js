define("CardLessModule/frmCardLessHomeQR", function() {
    return function(controller) {
        function addWidgetsfrmCardLessHomeQR() {
            ...
            customHeader.lblLocateUs.text = "Card-less Cash";
            ...
            flxShadow.add();
            var flxWithdrawCash = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "centerX": "50%",
                "clipBounds": true,
                "height": "90dp",
            ...
            flxWithdrawCash.setDefaultUnit(kony.flex.DP);
            ...
            var lblWithdrawCash = new kony.ui.Label({
                "bottom": "15dp",
                "centerX": "50%",
                "id": "lblWithdrawCash",
                "isVisible": true,
                "skin": "sknLblffffff22px",
                "i18n_text": "kony.i18n.getLocalizedString(\"kony.mb.cardLess.withdrawCash\")",
                "textStyle": {},
            ...
            flxWithdrawCash.add(imgCheckDeposit, lblWithdrawCash);
            ...
            var flxHeaderNT = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": true,
                "height": "40dp",
                "id": "flxHeaderNT",
            ...
            flxHeaderNT.setDefaultUnit(kony.flex.DP);
            var flxShadowNT = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": true,
                "height": "5dp",
                "id": "flxShadowNT",
            ...
            flxShadowNT.setDefaultUnit(kony.flex.DP);
            flxShadowNT.add();
            var lblHeaderPending = new kony.ui.Label({
                "centerY": "50%",
                "id": "lblHeaderPending",
                "isVisible": true,
                "left": "20dp",
                "skin": "sknLbl424242SSP26px",
                "i18n_text": "kony.i18n.getLocalizedString(\"kony.mb.accdetails.postedTransactions\")",
                "textStyle": {},
                "width": kony.flex.USE_PREFFERED_SIZE,
                "zIndex": 6
            }, {
            ...
            flxHeaderNT.add(flxShadowNT, lblHeaderPending);
            ...
            flxNoTransactions.add(flxHeaderNT, flxSeperator3, lblNoTransaction);
            flxMainContainer.add(flxToastDummy, flxSearch, flxShadow, flxWithdrawCash, flxSeperator2, segDepositFrom, flxNoTransactions);
            ...
            flxFooter.add(flxSeperator1, customFooter);
            ...
            this.add(flxHeader, flxMainContainer, flxFooter, flxPopup, flxHeaderSearchbox, flxGradient, flxWhite, flxHamburger, flxGradientBottom);
        };
        return [{
            "addWidgets": addWidgetsfrmCardLessHomeQR,
            "enabledForIdleTimeout": true,
            "id": "frmCardLessHomeQR",
            "init": controller.AS_Form_c751cdac9c2d4d14a1d40d5a56f36857,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "postShow": controller.AS_Form_c443d43ea44943109e1212c39eab9fea,
            "preShow": controller.AS_Form_cc915ca7af834f358ea3eded3e849fe3,
            "skin": "sknFrmffffff",
            "i18n_title": "kony.i18n.getLocalizedString(\"kony.mb.Hamburger.CardLessCash\")"
        }, {
