define({
    ...
    btnContinueOnClick: function() {
        if (this.contactType === "phone") {
            ...
            var cLMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("CardLessModule");
            cLMod.presentationController.setCardlessPhoneNumber(this.contactData);
        } else {
            var cLMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("CardLessModule");
            cLMod.presentationController.setCardlessEmail(this.contactData);
        }
    },
    showPopup: function() {
    ...
    isSelectedNumberOrEmail: function() {
        if (this.view.imgRadioBtn5.src === "radiobuttoninactive.png" && this.view.imgRadioBtn2.src === "radiobuttoninactive.png" && this.view.imgRadioBtn3.src === "radiobuttoninactive.png" && this.view.imgRadioBtn4.src === "radiobuttoninactive.png" && this.view.imgRadioBtn1.src === "radiobuttoninactive.png") {
            return false;
        } else {
            return true;
        }
