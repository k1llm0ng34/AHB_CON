        ...
        try {
            ...
            if (cardData.hasOwnProperty("Addresses")) {
                ...
                if (noOfRegisteredAddresses === 0) {
                    ...
                    address1 = addressesOfUsers[0].addressLine1 + ", " + addressesOfUsers[0].addressLine2 + ", " + addressesOfUsers[0].city + ", " + addressesOfUsers[0].country + ", " + addressesOfUsers[0].zipcode;
                    ...
                    address1 = addressesOfUsers[0].addressLine1 + ", " + addressesOfUsers[0].addressLine2 + ", " + addressesOfUsers[0].city + ", " + addressesOfUsers[0].country + ", " + addressesOfUsers[0].zipcode;
                    this.view.lblAddress1.text = address1;
                    address2 = addressesOfUsers[1].addressLine1 + ", " + addressesOfUsers[1].addressLine2 + ", " + addressesOfUsers[1].city + ", " + addressesOfUsers[1].country + ", " + addressesOfUsers[1].zipcode;
                    ...
                    address2 = addressesOfUsers[1].addressLine1 + ", " + addressesOfUsers[1].addressLine2 + ", " + addressesOfUsers[1].city + ", " + addressesOfUsers[1].country + ", " + addressesOfUsers[1].zipcode;
                    this.view.lblAddress2.text = address2;
                    address3 = addressesOfUsers[2].addressLine1 + ", " + addressesOfUsers[2].addressLine2 + ", " + addressesOfUsers[2].city + ", " + addressesOfUsers[2].country + ", " + addressesOfUsers[2].zipcode;
