            ...
            defineSetter(this, "graphColor", function(val) {
                ...
                try {
                    if (this.hexCodeFormat.test(val)) {
                        ...
                        throw {
                            "Error": "InvalidGraphColorCode",
                            "message": "The graph color code must be in hex format. Eg.:#000000"
                        };
                    }
                } catch (exception) {
        ...
        createChart: function(dataSet) {
            ...
            try {
                ...
                if (this.validateAllParams(this._chartTitle, labels, series, this._chartProperties)) {
                    this.view.areaChartBrowser.evaluateJavaScript('var chartObj = new konymp.charts.areaChart(); chartObj.drawAreaChart(' + JSON.stringify(this._chartTitle) + ',' + JSON.stringify(labels) + ',' + JSON.stringify(series) + ',' + JSON.stringify(this._chartProperties) + ')');
        ...
        validateAllParams: function(title, labels, series, properties) {
            ...
            try {
                ...
                if (!this.validateData(properties._graphColor, 'string')) {
                    throw {
                        "Error": "Invalid Datatype",
                        "message": "Wrong dataType for graphColor " + JSON.stringify(properties._graphColor)
                    };
                }
