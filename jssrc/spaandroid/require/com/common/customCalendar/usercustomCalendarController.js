    ...
    return {
        ...
        initActions: function() {
            ...
            this.view.flxNextMonth.onClick = function() {
                scope.view.flxMonth.widgets()[1].animate(kony.ui.createAnimation({
                    "100": {
                        "left": "-100%",
                        "stepConfig": {
                ...
                scope.view.flxMonth.widgets()[2].animate(kony.ui.createAnimation({
                    "100": {
                        "left": "0%",
                        "stepConfig": {
                            "timingFunction": kony.anim.EASE
            ...
            this.view.flxPreviousMonth.onClick = function() {
                ...
                scope.view.flxMonth.widgets()[0].animate(kony.ui.createAnimation({
                    "100": {
                        "left": "0%",
                        "stepConfig": {
                            "timingFunction": kony.anim.EASE
