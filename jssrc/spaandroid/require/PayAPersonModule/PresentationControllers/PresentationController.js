define(["AsyncManager/BusinessControllers/BusinessController"], function(AsyncManager) {
    ...
    PayAPerson_PresentationController.prototype.goBackToSelectRecipient = function() {
        ...
        var selPersonId = "";
        for (var i = 0; i < payee.allPayees.length; i++) {
            if (payee.allPayees[i].PayPersonId === personId) selPersonId = i;
        }
        return selPersonId;
    };
    ...
    PayAPerson_PresentationController.prototype.goToAmountForm = function() {
        ...
        if (accNo === null) defaultAccountData = accMan.getInternalAccountByID(defaultAccountID);
        else defaultAccountData = accMan.getInternalAccountByID(accNo);
        var data = [];
        ...
        if (amount !== null) amount = forUtility.deFormatAbsoluteAmount(amount);
    ...
    PayAPerson_PresentationController.prototype.setTransactionObject = function(transactionData) {
        ...
        if (transactionData.isScheduled === "true") transactionObj.setTransactionprimaryAttribute({
