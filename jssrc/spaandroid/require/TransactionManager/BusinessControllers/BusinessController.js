...
define([], function() {
    ...
    TransactionManager.prototype.convertDateFormat = function(transactionObj) {
        if (transactionObj.scheduledDate) transactionObj.scheduledDate = this.convertDateToBackendFormat(transactionObj.scheduledDate);
        if (transactionObj.frequencyStartDate) transactionObj.frequencyStartDate = this.convertDateToBackendFormat(transactionObj.frequencyStartDate);
        if (transactionObj.frequencyEndDate) transactionObj.frequencyEndDate = this.convertDateToBackendFormat(transactionObj.frequencyEndDate);
    ...
    TransactionManager.prototype.updateTransaction = function(tranObj, presentationSuccessCallback, presentationErrorCallback) {
        ...
        for (var key in tranObj) {
            if (tranObj[key] === "") delete transObj[key];
        }
    ...
    TransactionManager.prototype.createBulkBillPayPayement = function(transList, presentationSuccessCallback, presentationErrorCallback) {
        ...
        transactionModel.customVerb('createBulkBillPay', {
            'bulkPayString': transList
