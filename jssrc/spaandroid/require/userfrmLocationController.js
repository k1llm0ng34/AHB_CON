define({
    ...
    */
    ...
    setFlowActions: function() {
        ...
        this.view.flxDetailsMain.onClick = function() {
            if (scopeObj.view.imgDetails.src === "cardup.png") scopeObj.showFullDetails();
            else scopeObj.showSelectedLocation();
        };
        ...
        this.view.flxDirectionMain.onTouchEnd = function() {
            if (scopeObj.view.imgDirections.src === "cardup.png") scopeObj.showFullDirections();
            else scopeObj.showgetDirections();
        };
    ...
    showHeader: function() {
        this.view.flxHeaderAndSearch.setVisibility(true);
        this.view.flxHeaderSearchbox.setVisibility(false);
        if (this.view.flxBranchesList.isVisible) this.view.flxBranchesList.top = "55dp";
    },
    ...
    toggleCheckbox: function(segWidget) {
        ...
        if (segWidget === "segSelectSearchRange") {
            ...
            rowIndex = index[1];
            if (data[rowIndex].imgCheckbox.src === "radiobuttonactive.png") data[rowIndex].imgCheckbox.src = "radiobuttoninactive.png";
            else data[rowIndex].imgCheckbox.src = "radiobuttonactive.png";
            this.view.segSelectSearchRange.setData(data);
        } else {
    ...
    navigateBack: function() {
        var self = this;
        if (this.view.flxBranchesList.isVisible) self.setPreshowData();
    ...
    animateFlxUp: function() {
        var flx;
        if (this.view.flxDetails.isVisible) flx = this.view.flxDetails;
        else if (this.view.flxDirections.isVisible) flx = this.view.flxDirections;
        else flx = null;
        if (flx !== null) {
            flx.animate(kony.ui.createAnimation({
                "100": {
                    "top": "7%",
                    "stepConfig": {
            ...
            if (this.view.flxDetails.isVisible) this.showFullDetails();
            else if (this.view.flxDirections.isVisible) this.showFullDirections();
        }
    },
    animateFlxDown: function() {
        ...
        if (flx !== null) {
            ...
            if (this.view.flxDetails.isVisible) this.showSelectedLocation();
            else if (this.view.flxDirections.isVisible) this.showgetDirections();
        }
    },
    ...
    navigateToGivenLocation: function(latLongObj) {
        ...
        this.view.mapLocation.navigateToLocation({
    ...
    getMappedSelectedServices: function(serviceIndexes) {
        ...
        for (var i = 0; i < serviceIndexes.length; i++) {
            ...
            if (mapedElt !== null && mapedElt !== undefined) result.push(mapedElt);
        }
        return result;
    },
    /**
    ...
    getServicesMasterData: function() {
        var services = ["All", "Make an Appointment", "On-site Relationship Manager", "Home Loan Specialists", "Financial Advisors", "Investment Services", "Foreign Currency Exchange", "Retail Branch", "Wealth Branch", "Business Banking", "International Banking Center", "Commercial Deposits", "Night Deposits", "Safe Deposit Box", "Handicap Access", "ATM - Full Service", "ATM - Cash withdrawal Only", "ATM - Check Deposits", "ATM - Cash Deposits", "ATM - Cardless Cash Withdrawal", "ATM - Drive Up"];
        return services;
    },
    /**
    ...
    */
    setOldLocationData: function() {
        ...
        if (this.searchString !== null && this.searchString !== undefined) this.view.customSearch.tbxSearch.text = this.searchString;
