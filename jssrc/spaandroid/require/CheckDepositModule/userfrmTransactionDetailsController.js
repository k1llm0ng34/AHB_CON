define({
    ...
    onNavigate: function(obj) {
        ...
        if (transactionData.isScheduled !== undefined && transactionData.isScheduled !== null && transactionData.isScheduled === "true") {
            ...
            if (isIphone) this.view.setTitleBarRightSideButtonSkin("Edit", "sknBtnffffffSSPSemiBold30px", this.btnEditOnClick);
        } else {
            this.view.customHeader.btnRight.setVisibility(false);
            if (isIphone) this.view.setTitleBarRightSideButtonSkin("", "sknBtnffffffSSPSemiBold30px", function() {});
        }
