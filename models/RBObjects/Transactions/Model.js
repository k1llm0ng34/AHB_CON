define([],function(){
	...
	var setterFunctions = {
		...
		Transactions : function(val, state){
			state['Transactions'] = val;
		},
		chequeCurrency : function(val, state){
			state['chequeCurrency'] = val;
		},
		txnReferenceNumber : function(val, state){
			state['txnReferenceNumber'] = val;
		},
		chequeBankId : function(val, state){
			state['chequeBankId'] = val;
		},
		chequeNumber : function(val, state){
			state['chequeNumber'] = val;
		},
		txnTypeIndicator : function(val, state){
			state['txnTypeIndicator'] = val;
		},
		chequeAmount : function(val, state){
			state['chequeAmount'] = val;
		},
		chequeValueDate : function(val, state){
			state['chequeValueDate'] = val;
		},
		chequeDate : function(val, state){
			state['chequeDate'] = val;
		},
		cifId : function(val, state){
			state['cifId'] = val;
		},
		chequeImage : function(val, state){
			state['chequeImage'] = val;
		},
		ChequesList : function(val, state){
			state['ChequesList'] = val;
		},
		fromCurrency : function(val, state){
			state['fromCurrency'] = val;
		},
		beneficiaryAccountNumber : function(val, state){
			state['beneficiaryAccountNumber'] = val;
		},
		beneficiaryCurrency : function(val, state){
			state['beneficiaryCurrency'] = val;
		},
		txnAmount : function(val, state){
			state['txnAmount'] = val;
		},
		paymentMode : function(val, state){
			state['paymentMode'] = val;
		},
		transferType : function(val, state){
			state['transferType'] = val;
		},
		txnFrequency : function(val, state){
			state['txnFrequency'] = val;
		},
		txnStartDate : function(val, state){
			state['txnStartDate'] = val;
		},
		chargeIndicator : function(val, state){
			state['chargeIndicator'] = val;
		},
		beneficiaryBankCountry : function(val, state){
			state['beneficiaryBankCountry'] = val;
		},
		beneficiaryName : function(val, state){
			state['beneficiaryName'] = val;
		},
		txnPurpose : function(val, state){
			state['txnPurpose'] = val;
		},
		countrySpecificCode : function(val, state){
			state['countrySpecificCode'] = val;
		},
		txnRemarks : function(val, state){
			state['txnRemarks'] = val;
		},
		beneficiaryAddress1 : function(val, state){
			state['beneficiaryAddress1'] = val;
		},
		beneficiaryAddress2 : function(val, state){
			state['beneficiaryAddress2'] = val;
		},
		beneficiaryCity : function(val, state){
			state['beneficiaryCity'] = val;
		},
		beneficiaryState : function(val, state){
			state['beneficiaryState'] = val;
		},
		beneficiaryCountry : function(val, state){
			state['beneficiaryCountry'] = val;
		},
		beneficiaryZip : function(val, state){
			state['beneficiaryZip'] = val;
		},
		referenceNumber : function(val, state){
			state['referenceNumber'] = val;
		},
		txnDate : function(val, state){
			state['txnDate'] = val;
		},
		txnReasons : function(val, state){
			state['txnReasons'] = val;
		},
		countries : function(val, state){
			state['countries'] = val;
		},
		currencies : function(val, state){
			state['currencies'] = val;
		},
		fromCifId : function(val, state){
			state['fromCifId'] = val;
		},
		beneficiaryCifId : function(val, state){
			state['beneficiaryCifId'] = val;
		},
		nickName : function(val, state){
			state['nickName'] = val;
		},
		scheduledTxnId : function(val, state){
			state['scheduledTxnId'] = val;
		},
		createdDate : function(val, state){
			state['createdDate'] = val;
		},
		requestInput : function(val, state){
			state['requestInput'] = val;
		},
		isIban : function(val, state){
			state['isIban'] = val;
		},
		beneficiaryBankName : function(val, state){
			state['beneficiaryBankName'] = val;
		},
	};
	...
	function Transactions(defaultValues){
		var privateState = {};
			...
			privateState.bankCode = defaultValues?(defaultValues["bankCode"]?defaultValues["bankCode"]:null):null;
			...
			privateState.chequeStatus = defaultValues?(defaultValues["chequeStatus"]?defaultValues["chequeStatus"]:null):null;
			...
			privateState.Transactions = defaultValues?(defaultValues["Transactions"]?defaultValues["Transactions"]:null):null;
			privateState.chequeCurrency = defaultValues?(defaultValues["chequeCurrency"]?defaultValues["chequeCurrency"]:null):null;
			privateState.txnReferenceNumber = defaultValues?(defaultValues["txnReferenceNumber"]?defaultValues["txnReferenceNumber"]:null):null;
			privateState.chequeBankId = defaultValues?(defaultValues["chequeBankId"]?defaultValues["chequeBankId"]:null):null;
			privateState.chequeNumber = defaultValues?(defaultValues["chequeNumber"]?defaultValues["chequeNumber"]:null):null;
			privateState.txnTypeIndicator = defaultValues?(defaultValues["txnTypeIndicator"]?defaultValues["txnTypeIndicator"]:null):null;
			privateState.chequeAmount = defaultValues?(defaultValues["chequeAmount"]?defaultValues["chequeAmount"]:null):null;
			privateState.chequeValueDate = defaultValues?(defaultValues["chequeValueDate"]?defaultValues["chequeValueDate"]:null):null;
			privateState.chequeDate = defaultValues?(defaultValues["chequeDate"]?defaultValues["chequeDate"]:null):null;
			privateState.cifId = defaultValues?(defaultValues["cifId"]?defaultValues["cifId"]:null):null;
			privateState.chequeImage = defaultValues?(defaultValues["chequeImage"]?defaultValues["chequeImage"]:null):null;
			privateState.ChequesList = defaultValues?(defaultValues["ChequesList"]?defaultValues["ChequesList"]:null):null;
			privateState.fromCurrency = defaultValues?(defaultValues["fromCurrency"]?defaultValues["fromCurrency"]:null):null;
			privateState.beneficiaryAccountNumber = defaultValues?(defaultValues["beneficiaryAccountNumber"]?defaultValues["beneficiaryAccountNumber"]:null):null;
			privateState.beneficiaryCurrency = defaultValues?(defaultValues["beneficiaryCurrency"]?defaultValues["beneficiaryCurrency"]:null):null;
			privateState.txnAmount = defaultValues?(defaultValues["txnAmount"]?defaultValues["txnAmount"]:null):null;
			privateState.paymentMode = defaultValues?(defaultValues["paymentMode"]?defaultValues["paymentMode"]:null):null;
			privateState.transferType = defaultValues?(defaultValues["transferType"]?defaultValues["transferType"]:null):null;
			privateState.txnFrequency = defaultValues?(defaultValues["txnFrequency"]?defaultValues["txnFrequency"]:null):null;
			privateState.txnStartDate = defaultValues?(defaultValues["txnStartDate"]?defaultValues["txnStartDate"]:null):null;
			privateState.chargeIndicator = defaultValues?(defaultValues["chargeIndicator"]?defaultValues["chargeIndicator"]:null):null;
			privateState.beneficiaryBankCountry = defaultValues?(defaultValues["beneficiaryBankCountry"]?defaultValues["beneficiaryBankCountry"]:null):null;
			privateState.beneficiaryName = defaultValues?(defaultValues["beneficiaryName"]?defaultValues["beneficiaryName"]:null):null;
			privateState.txnPurpose = defaultValues?(defaultValues["txnPurpose"]?defaultValues["txnPurpose"]:null):null;
			...
			privateState.txnRemarks = defaultValues?(defaultValues["txnRemarks"]?defaultValues["txnRemarks"]:null):null;
			privateState.beneficiaryAddress1 = defaultValues?(defaultValues["beneficiaryAddress1"]?defaultValues["beneficiaryAddress1"]:null):null;
			privateState.beneficiaryAddress2 = defaultValues?(defaultValues["beneficiaryAddress2"]?defaultValues["beneficiaryAddress2"]:null):null;
			privateState.beneficiaryCity = defaultValues?(defaultValues["beneficiaryCity"]?defaultValues["beneficiaryCity"]:null):null;
			privateState.beneficiaryState = defaultValues?(defaultValues["beneficiaryState"]?defaultValues["beneficiaryState"]:null):null;
			privateState.beneficiaryCountry = defaultValues?(defaultValues["beneficiaryCountry"]?defaultValues["beneficiaryCountry"]:null):null;
			privateState.beneficiaryZip = defaultValues?(defaultValues["beneficiaryZip"]?defaultValues["beneficiaryZip"]:null):null;
			privateState.referenceNumber = defaultValues?(defaultValues["referenceNumber"]?defaultValues["referenceNumber"]:null):null;
			privateState.txnDate = defaultValues?(defaultValues["txnDate"]?defaultValues["txnDate"]:null):null;
			privateState.txnReasons = defaultValues?(defaultValues["txnReasons"]?defaultValues["txnReasons"]:null):null;
			privateState.countries = defaultValues?(defaultValues["countries"]?defaultValues["countries"]:null):null;
			privateState.currencies = defaultValues?(defaultValues["currencies"]?defaultValues["currencies"]:null):null;
			privateState.fromCifId = defaultValues?(defaultValues["fromCifId"]?defaultValues["fromCifId"]:null):null;
			privateState.beneficiaryCifId = defaultValues?(defaultValues["beneficiaryCifId"]?defaultValues["beneficiaryCifId"]:null):null;
			privateState.nickName = defaultValues?(defaultValues["nickName"]?defaultValues["nickName"]:null):null;
			privateState.scheduledTxnId = defaultValues?(defaultValues["scheduledTxnId"]?defaultValues["scheduledTxnId"]:null):null;
			privateState.createdDate = defaultValues?(defaultValues["createdDate"]?defaultValues["createdDate"]:null):null;
			privateState.requestInput = defaultValues?(defaultValues["requestInput"]?defaultValues["requestInput"]:null):null;
			privateState.isIban = defaultValues?(defaultValues["isIban"]?defaultValues["isIban"]:null):null;
			privateState.beneficiaryBankName = defaultValues?(defaultValues["beneficiaryBankName"]?defaultValues["beneficiaryBankName"]:null):null;
		...
		//Defining Getter/Setters
			Object.defineProperties(this,{
				...
				"transactionId" : {
					...
					set : function(val){throw Error("transactionId cannot be changed."); },
					enumerable : true,
				},
				"transactionsNotes" : {
				...
				"bankCode" : {
					get : function(){return privateState.bankCode},
					set : function(val){
				...
				"chequeStatus" : {
					get : function(){return privateState.chequeStatus},
					set : function(val){
				...
				"Transactions" : {
					get : function(){return privateState.Transactions},
					set : function(val){
						setterFunctions['Transactions'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeCurrency" : {
					get : function(){return privateState.chequeCurrency},
					set : function(val){
						setterFunctions['chequeCurrency'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnReferenceNumber" : {
					get : function(){return privateState.txnReferenceNumber},
					set : function(val){
						setterFunctions['txnReferenceNumber'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeBankId" : {
					get : function(){return privateState.chequeBankId},
					set : function(val){
						setterFunctions['chequeBankId'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeNumber" : {
					get : function(){return privateState.chequeNumber},
					set : function(val){
						setterFunctions['chequeNumber'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnTypeIndicator" : {
					get : function(){return privateState.txnTypeIndicator},
					set : function(val){
						setterFunctions['txnTypeIndicator'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeAmount" : {
					get : function(){return privateState.chequeAmount},
					set : function(val){
						setterFunctions['chequeAmount'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeValueDate" : {
					get : function(){return privateState.chequeValueDate},
					set : function(val){
						setterFunctions['chequeValueDate'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chequeDate" : {
					get : function(){return privateState.chequeDate},
					set : function(val){
						setterFunctions['chequeDate'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"cifId" : {
				...
				"chequeImage" : {
					get : function(){return privateState.chequeImage},
					set : function(val){
						setterFunctions['chequeImage'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"ChequesList" : {
					get : function(){return privateState.ChequesList},
					set : function(val){
						setterFunctions['ChequesList'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"fromCurrency" : {
					get : function(){return privateState.fromCurrency},
					set : function(val){
						setterFunctions['fromCurrency'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryAccountNumber" : {
					get : function(){return privateState.beneficiaryAccountNumber},
					set : function(val){
						setterFunctions['beneficiaryAccountNumber'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryCurrency" : {
					get : function(){return privateState.beneficiaryCurrency},
					set : function(val){
						setterFunctions['beneficiaryCurrency'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnAmount" : {
					get : function(){return privateState.txnAmount},
					set : function(val){
						setterFunctions['txnAmount'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"paymentMode" : {
					get : function(){return privateState.paymentMode},
					set : function(val){
						setterFunctions['paymentMode'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"transferType" : {
					get : function(){return privateState.transferType},
					set : function(val){
						setterFunctions['transferType'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnFrequency" : {
					get : function(){return privateState.txnFrequency},
					set : function(val){
						setterFunctions['txnFrequency'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnStartDate" : {
					get : function(){return privateState.txnStartDate},
					set : function(val){
						setterFunctions['txnStartDate'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"chargeIndicator" : {
					get : function(){return privateState.chargeIndicator},
					set : function(val){
						setterFunctions['chargeIndicator'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryBankCountry" : {
					get : function(){return privateState.beneficiaryBankCountry},
					set : function(val){
				...
				"txnPurpose" : {
					get : function(){return privateState.txnPurpose},
					set : function(val){
						setterFunctions['txnPurpose'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"countrySpecificCode" : {
				...
				"txnRemarks" : {
					get : function(){return privateState.txnRemarks},
					set : function(val){
						setterFunctions['txnRemarks'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryAddress1" : {
					get : function(){return privateState.beneficiaryAddress1},
					set : function(val){
				...
				"beneficiaryAddress2" : {
					get : function(){return privateState.beneficiaryAddress2},
					set : function(val){
				...
				"beneficiaryCity" : {
					get : function(){return privateState.beneficiaryCity},
					set : function(val){
				...
				"beneficiaryState" : {
					get : function(){return privateState.beneficiaryState},
					set : function(val){
				...
				"beneficiaryCountry" : {
					get : function(){return privateState.beneficiaryCountry},
					set : function(val){
				...
				"beneficiaryZip" : {
					get : function(){return privateState.beneficiaryZip},
					set : function(val){
						setterFunctions['beneficiaryZip'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"referenceNumber" : {
					get : function(){return privateState.referenceNumber},
					set : function(val){
				...
				"txnDate" : {
					get : function(){return privateState.txnDate},
					set : function(val){
						setterFunctions['txnDate'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"txnReasons" : {
					get : function(){return privateState.txnReasons},
					set : function(val){
						setterFunctions['txnReasons'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"countries" : {
					get : function(){return privateState.countries},
					set : function(val){
						setterFunctions['countries'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"currencies" : {
					get : function(){return privateState.currencies},
					set : function(val){
				...
				"fromCifId" : {
					get : function(){return privateState.fromCifId},
					set : function(val){
						setterFunctions['fromCifId'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryCifId" : {
					get : function(){return privateState.beneficiaryCifId},
					set : function(val){
						setterFunctions['beneficiaryCifId'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"nickName" : {
				...
				"scheduledTxnId" : {
					get : function(){return privateState.scheduledTxnId},
					set : function(val){
						setterFunctions['scheduledTxnId'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"createdDate" : {
				...
				"requestInput" : {
					get : function(){return privateState.requestInput},
					set : function(val){
						setterFunctions['requestInput'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"isIban" : {
					get : function(){return privateState.isIban},
					set : function(val){
						setterFunctions['isIban'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"beneficiaryBankName" : {
					get : function(){return privateState.beneficiaryBankName},
					set : function(val){
	...
	Transactions.deleteUserScheduledTransaction = function(params, onCompletion){
		return Transactions.customVerb('deleteUserScheduledTransaction', params, onCompletion);
	};
	...
	Transactions.updateUserScheduledTransaction = function(params, onCompletion){
		return Transactions.customVerb('updateUserScheduledTransaction', params, onCompletion);
	};
	...
	Transactions.getUserChequeImage = function(params, onCompletion){
		return Transactions.customVerb('getUserChequeImage', params, onCompletion);
	};
	...
	Transactions.getUserChequesList = function(params, onCompletion){
		return Transactions.customVerb('getUserChequesList', params, onCompletion);
	};
	...
	Transactions.getTransferConfigurations = function(params, onCompletion){
		return Transactions.customVerb('getTransferConfigurations', params, onCompletion);
	};
