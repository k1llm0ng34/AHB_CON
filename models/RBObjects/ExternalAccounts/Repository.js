define([],function(){
	...
	ExternalAccountsRepository.prototype.getBankDetails = function(params,onCompletion){
		return ExternalAccountsRepository.prototype.customVerb('getBankDetails',params, onCompletion);
	};
