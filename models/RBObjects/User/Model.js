define([],function(){
	...
	var setterFunctions = {
		...
		deviceName : function(val, state){
			state['deviceName'] = val;
		},
		isDeviceActive : function(val, state){
			state['isDeviceActive'] = val;
		},
		modelName : function(val, state){
			state['modelName'] = val;
		},
		newPin : function(val, state){
			state['newPin'] = val;
		},
		currentPin : function(val, state){
	...
	function User(defaultValues){
		var privateState = {};
			...
			privateState.deviceName = defaultValues?(defaultValues["deviceName"]?defaultValues["deviceName"]:null):null;
			privateState.isDeviceActive = defaultValues?(defaultValues["isDeviceActive"]?defaultValues["isDeviceActive"]:null):null;
			privateState.modelName = defaultValues?(defaultValues["modelName"]?defaultValues["modelName"]:null):null;
			privateState.newPin = defaultValues?(defaultValues["newPin"]?defaultValues["newPin"]:null):null;
			privateState.currentPin = defaultValues?(defaultValues["currentPin"]?defaultValues["currentPin"]:null):null;
		...
		//Defining Getter/Setters
			Object.defineProperties(this,{
				...
				"userId" : {
					...
					set : function(val){throw Error("userId cannot be changed."); },
					enumerable : true,
				},
				"userImage" : {
				...
				"deviceName" : {
					get : function(){return privateState.deviceName},
					set : function(val){
						setterFunctions['deviceName'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"isDeviceActive" : {
					get : function(){return privateState.isDeviceActive},
					set : function(val){
						setterFunctions['isDeviceActive'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"modelName" : {
					get : function(){return privateState.modelName},
					set : function(val){
						setterFunctions['modelName'].call(this,val,privateState);
					},
					enumerable : true,
				},
				"newPin" : {
					get : function(){return privateState.newPin},
					set : function(val){
				...
				"currentPin" : {
					get : function(){return privateState.currentPin},
					set : function(val){
						setterFunctions['currentPin'].call(this,val,privateState);
					},
					enumerable : true,
				},
			});
	...
	//For Operation 'updateDeviceDetails' with service id 'updateUserDevices5633'
	User.updateDeviceDetails = function(params, onCompletion){
		return User.customVerb('updateDeviceDetails', params, onCompletion);
	};
	...
	//For Operation 'getAllDevices' with service id 'getUserDevices2585'
	User.getAllDevices = function(params, onCompletion){
		return User.customVerb('getAllDevices', params, onCompletion);
	};
	...
	//For Operation 'getConfigurations' with service id 'konyadminconsole_configurations_get6566'
	User.getConfigurations = function(params, onCompletion){
		return User.customVerb('getConfigurations', params, onCompletion);
	};
	...
	//For Operation 'updateDeviceStatus' with service id 'updateDeviceStatus2234'
	User.updateDeviceStatus = function(params, onCompletion){
		return User.customVerb('updateDeviceStatus', params, onCompletion);
	};
