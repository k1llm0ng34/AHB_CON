		...
		//Defining Getter/Setters
			Object.defineProperties(this,{
				"main_user" : {
					...
					set : function(val){throw Error("main_user cannot be changed."); },
					enumerable : true,
				},
				"username" : {
				...
				"bank_id" : {
					...
					set : function(val){throw Error("bank_id cannot be changed."); },
					enumerable : true,
				},
				"AccountName" : {
					get : function(){return privateState.AccountName},
					set : function(val){throw Error("AccountName cannot be changed."); },
					enumerable : true,
				},
				"AvailableBalance" : {
				...
				"loop_count" : {
					...
					set : function(val){throw Error("loop_count cannot be changed."); },
					enumerable : true,
				},
				"Account_id" : {
