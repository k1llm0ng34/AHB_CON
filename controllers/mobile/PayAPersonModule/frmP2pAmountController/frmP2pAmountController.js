define({
	...
	continueOnClick: function() {
		...
		if(amountEntered>=configManager.getConfigurationValue("minP2PLimit") && amountEntered<=configManager.getConfigurationValue("maxP2PLimit") )
		{
        ...
        data.fromAvlBal = this.view.lblBalanceValue.text;
      ...
      this.bindGenericError(kony.i18n.getLocalizedString("kony.mb.entitlements.minTransactionLimitUnreached") + " "+Number(configManager.getConfigurationValue("minP2PLimit"))); 
    }
	else if(Number(amountEntered)>Number(configManager.getConfigurationValue("maxP2PLimit")) ){
	  this.bindGenericError(kony.i18n.getLocalizedString("kony.mb.entitlements.maxTransactionLimitExceeded") + " "+Number(configManager.getConfigurationValue("maxP2PLimit")));
