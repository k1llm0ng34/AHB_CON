define({ 
  ...
  setSegmentData: function(){
    ...
    if(transferMod.presentationController.isEligibleTransferType("isKonyBankAccountsTransfer")=="true")
      data.push({
    ...
    //"imgArrow":"chevron.png"
    //},
    if(transferMod.presentationController.isEligibleTransferType("isOtherKonyAccountsTransfer")=="true")
      data.push({
    ...
    if(transferMod.presentationController.isEligibleTransferType("isOtherBankAccountsTransfer")=="true")
      data.push({
    ...
    if(transferMod.presentationController.isEligibleTransferType("isInternationalAccountsTransfer")=="true")
      data.push({
