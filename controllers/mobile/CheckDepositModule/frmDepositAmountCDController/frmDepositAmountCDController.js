define({ 
  ...
  onBtnContinueClick: function(){
    ...
    if(Number(data.amount) < Number(configManager.getConfigurationValue("minRDCLimit"))) {
        ...
        this.bindGenericError(i18nKeyMin+configManager.getConfigurationValue("minRDCLimit"));
    }
        ...
        this.bindGenericError(i18nKeyMax+configManager.getConfigurationValue("maxRDCLimit"));
    }
   	else {
    	applicationManager.getPresentationUtility().showLoadingScreen();
  ...
  setFlxData: function() {
    ...
    this.view.lblFromAccountValue.text = flxData.accountInfo.lblAccountName;
