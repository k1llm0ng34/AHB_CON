...
public  class AppSpecificFunctions {
    ...
    public static frmLogin signOut() throws Exception
    {
        ...
        {
            AppSpecificFunctions.clickAppElement("frmDashboardAggregated_imgLogout");
//          FormMoreLandingKA frmMoreLandingKA = new FormMoreLandingKA();
//          return frmMoreLandingKA.clickSignOut();
        }
...
public static String[] getSegDetails(String[] segParameters,int index) throws IOException, Exception
  {
    ...
    public static void backToApp() throws Exception
    {
        ...
        {
//          new AppElement("Back to KonyRetailBanking").click();
        }
    }
...
//            AppSpecificFunctions.clickAppElement("frmDashboardAggregated_Transfers");
    ...
    public static boolean isfullScreenAdLoading() throws Exception {
        if(AppElement.isElementVisible("id","frmFullScreenAds_flxLoadingIndicator"))
            return true;
        return false;
    }

    public static boolean isfullScreenAdAvailable() throws Exception {
        if(AppElement.isElementVisible("id","frmFullScreenAds_flxAd1")||
                AppElement.isElementVisible("id","frmFullScreenAds_flxAd2")||
                AppElement.isElementVisible("id","frmFullScreenAds_flxAd3")||
                AppElement.isElementVisible("id","frmFullScreenAds_flxAd4")||
                AppElement.isElementVisible("id","frmFullScreenAds_flxAd5"))
            return true;
        return false;
    }
