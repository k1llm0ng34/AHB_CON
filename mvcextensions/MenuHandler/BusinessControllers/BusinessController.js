...
//       else
//         quickActionItem = params["quickactionitem"];
      if (quickActionItem) {
    ...
    var switchOnClick=function(selValue){
      ...
      switch(selValue){
        case configManager.constants.MENUACCOUNTS:   
          ...
          accountModule.presentationController.showAccountDetailView(configManager.constants.ENTRY_POINT.Hamburger,null);
          break;
        case configManager.constants.MENUHOME:   
          scope.view.flxHamburger.isVisible = false;
        ...
        case configManager.constants.MENUTRANSFERS:
          ...
          transMod.presentationController.initializeTransfersFlow();
           var navManger = applicationManager.getNavigationManager();
          navManger.setEntryPoint(configManager.constants.ENTRY_POINT.makeatransfer,configManager.constants.ENTRY_POINT.Hamburger);
           navManger.navigateTo("frmTransfers");
          break;
        ...
        case configManager.constants.MENUBILLPAY:
          ...
          var navManger = applicationManager.getNavigationManager();
          var BillPayMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("BillPayModule");
          BillPayMod.presentationController.initializePaymentModule(); 
          navManger.setEntryPoint("frmAccountDetails","BillPay");
        ...
        case configManager.constants.MENUSETTINGS: 
          navManger = applicationManager.getNavigationManager();
          scope.view.flxHamburger.isVisible = false;
          navManger.navigateTo("frmAHBSettingsHome");
...
//             }
   ...
   */ 
   ...
   //   if(devManager.isIPhone()){
        ...
        scope.view.customFooter.imgHome.src=footerData[0].img;
        //scope.view.customFooter.lblHome.text=footerData[0].text;
        scope.view.customFooter.flxHome.onClick=function(){
          switchOnClick(configManager.constants.MENUHOME);
          scope.view.customFooter.imgHome.src= "homeselected.png";
          showOrHideHamburgerUI(true);
        };
      
        scope.view.customFooter.imgAccounts.src=footerData[1].img;
        //scope.view.customFooter.lblAccounts.text=footerData[1].text;
        scope.view.customFooter.flxAccounts.onClick=function(){
          switchOnClick(configManager.constants.MENUACCOUNTS);
          scope.view.customFooter.imgAccounts.src= "myaccountsselected.png";
          showOrHideHamburgerUI(true);
        };
        scope.view.customFooter.imgTransfer.src=footerData[2].img;
        //scope.view.customFooter.lblTransfer.text=footerData[2].text;
        scope.view.customFooter.flxTransfer.onClick=function(){
        scope.view.customFooter.imgTransfer.src= "transfersselected.png";
          showOrHideHamburgerUI(true);
          switchOnClick(configManager.constants.MENUTRANSFERS);
        };
        scope.view.customFooter.imgBillPay.src=footerData[3].img;
        //scope.view.customFooter.lblBillPay.text=footerData[3].text;
        scope.view.customFooter.flxBillPay.onClick=function(){
        scope.view.customFooter.imgBillPay.src= "paybillsselected.png";
        switchOnClick(configManager.constants.MENUBILLPAY);
        showOrHideHamburgerUI(true);
      };
      scope.view.customFooter.imgBillPay.src=footerData[4].img;
        //scope.view.customFooter.lblBillPay.text=footerData[3].text;
        scope.view.customFooter.flxMore.onClick=function(){
        scope.view.customFooter.imgMore.src= "moreselected.png";
        switchOnClick(configManager.constants.MENUSETTINGS);
        showOrHideHamburgerUI(true);
      };
        //highlightWhichMenu
      ...
      scope.view.customFooter.imgHome.src="homedisabled.png";
      scope.view.customFooter.imgAccounts.src="myaccountsdisabled.png";
      scope.view.customFooter.imgTransfer.src="transfersdisabled.png";
      scope.view.customFooter.imgBillPay.src="paybillsdisabled.png";
      scope.view.customFooter.imgMore.src ="moredisabled.png";
      scope.view.customFooter.lblHome.skin = "sknLblA0A0A0SSP20px";
      ...
      if(selectedForm==footerData[0].text){
          ...
          scope.view.customFooter.imgHome.src= "homeselected.png";
          scope.view.customFooter.lblHome.skin = "sknLbl424242SSP20px";
...
//     }
    ...
    scope.view.customFooter.flxMore.onClick = function(){ 
      kony.print("Enter into Footer more onclick-->");
